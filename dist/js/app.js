(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".slider-items__slider")) new swiper_core_Swiper(".slider-items__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        menuLinks.forEach((link => {
            link.addEventListener("click", (function(event) {
                ...
                if (menuItem.classList.contains("_active")) return;
                event.preventDefault();
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const buttons = document.querySelectorAll(".scrolled__btn");
        buttons.forEach((button => {
            button.addEventListener("click", (function() {
                document.querySelector(".scrolled__btn._active").classList.remove("_active");
                this.classList.add("_active");
                const dataId = this.getAttribute("data-id");
                const targetElement = document.querySelector(`.scrolled__content.${dataId}`);
